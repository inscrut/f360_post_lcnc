...
var toolVectorOutputI = createOutputVariable({prefix:"A"}, abcFormat);
var toolVectorOutputJ = createOutputVariable({prefix:"B"}, abcFormat);
var toolVectorOutputK = createOutputVariable({prefix:"C"}, abcFormat);
